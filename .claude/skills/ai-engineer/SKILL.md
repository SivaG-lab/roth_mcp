...
description: >
  ...
  orchestration, and enterprise AI integrations. Use when building LLM
  features, chatbots, AI agents, or AI-powered applications. Triggers:
  ai engineer, llm application, rag system, vector search, multimodal ai,
  chatbot, ai integration, embedding pipeline.
user-invokable: true
argument-hint: "<AI feature or LLM application to build>"
metadata:
  model: sonnet
---
