...
description: >
  Orchestrate a structured, sequential multi-agent design review where
  each agent has a strict, non-overlapping role. Surfaces hidden
  assumptions, identifies failure modes, and prevents premature
  convergence. Use when a design requires higher confidence, risk
  reduction, or formal review. Triggers: brainstorm design, design review,
  multi-agent review, peer review, risk analysis, validate design.
user-invokable: true
argument-hint: "<design or idea to review>"
---
