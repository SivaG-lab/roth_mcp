...
description: >
  ...
  DESIGN.md files. Extracts design tokens, color palettes, typography,
  spacing, and component patterns from project assets. Use when creating
  DESIGN.md files, analyzing Stitch projects, or building semantic design
  systems. Triggers: design.md, stitch design, design system, semantic design.
user-invokable: true
argument-hint: "<Stitch project to analyze>"
metadata:
  source-url: "https://github.com/google-labs-code/stitch-skills/tree/main/skills/design-md"
---
