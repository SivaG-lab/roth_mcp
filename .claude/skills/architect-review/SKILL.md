...
description: >
  ...
  scalability, and maintainability. Use when reviewing architecture,
  evaluating design decisions, or assessing system scalability. Triggers:
  architecture review, design review, system architecture, clean architecture,
  microservices review, architectural decision.
user-invokable: true
argument-hint: "<system or design to review>"
metadata:
  model: opus
---
