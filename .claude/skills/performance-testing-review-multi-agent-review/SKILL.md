...
description: "Orchestrate multi-agent code reviews with parallel specialized agents (security, architecture, performance, compliance). Use when performing comprehensive code review with multiple perspectives, coordinating review agents, or synthesizing multi-agent review results."
---
