...
description: >
  ...
  Covers endpoints, parameters, request/response examples, authentication,
  error handling, and usage guidelines. Use when documenting REST, GraphQL,
  or WebSocket APIs. Triggers: api docs, generate api documentation,
  endpoint docs, swagger docs, api reference.
user-invokable: true
argument-hint: "<API codebase or endpoint to document>"
---
