...
description: >
  ...
  aesthetics, high craft, and non-generic visual identity. Covers design
  systems, DFII scoring, and memorable UI creation. Use when building or
  styling web UIs, components, pages, dashboards, or frontend applications.
  Triggers: frontend design, distinctive ui, web design, ui styling,
  production ui, design system, visual identity.
user-invokable: true
argument-hint: "<UI component, page, or design task>"
---
