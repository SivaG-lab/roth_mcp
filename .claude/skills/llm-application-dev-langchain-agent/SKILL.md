...
description: >
  Expert LangChain agent developer for production-grade AI systems using
  LangChain 0.1+ and LangGraph. Covers agent design, tool integration,
  memory patterns, and deployment. Use when building LangChain agents,
  implementing tool-calling systems, or designing agent workflows.
  Triggers: langchain agent, langchain tools, agent development,
  langchain production, langchain 0.1.
user-invokable: true
argument-hint: "<LangChain agent or workflow to build>"
---
