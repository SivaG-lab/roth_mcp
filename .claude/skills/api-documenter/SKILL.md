...
name: api-documenter
description: >
  Master API documentation with OpenAPI 3.1, AI-powered tools, and modern
  developer experience practices. Create interactive docs, generate SDKs,
  and build developer portals. Use when creating OpenAPI specs, building
  developer portals, or generating SDK documentation. Triggers: openapi,
  api spec, developer portal, sdk docs, asyncapi, api documentation.
user-invokable: true
argument-hint: "<API spec or developer portal to build>"
metadata:
  model: sonnet
---
